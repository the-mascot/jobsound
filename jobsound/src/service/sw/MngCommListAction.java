...
public class MngCommListAction implements CommandProcess {

	@Override
	public String requestPro(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		
		dao.sw.BoardDao cbd = dao.sw.BoardDao.getInstance();
		
		try {
			int totCnt = cbd.CommTotalCnt();
			...
			List<dao.sw.Board> list = cbd.Commlist(startRow, endRow);
