...
public class MngMemSearchAction implements CommandProcess {

	@Override
	public String requestPro(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {

		MemberInfoDao mbid = MemberInfoDao.getInstance();

		try {
			String keyWord = request.getParameter("keyWord");

			int totCnt = mbid.getSearchCnt(keyWord);
			...
			List<MemberInfo> list = mbid.searchList(keyWord, startRow, endRow);
