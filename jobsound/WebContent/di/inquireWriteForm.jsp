...
<section>
	...
	<form action="<%=context %>/di/inquireWritePro.do" method="post">
		<input type="hidden" name="id" id="id" value="${id}">
		<input type="hidden" name="inqNum" id="inqNum" value="${inqNum}">
		<table class="table table-sm">
			<tr>
				<td><div class="mb-3">
					<input type="text" class="form-control" id="inqTitle" placeholder="제목을 입력하세요." name="inqTitle">
					</div>
				</td>
			</tr>
			<tr>
				<td><textarea id="summernote" name="inqContent"></textarea></td>
			</tr>
		</table>
