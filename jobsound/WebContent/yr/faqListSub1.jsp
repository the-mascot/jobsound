...
<div class="accordion accordion-flush" id="accordionFlushExample">
  <div class="accordion-item">
    ...
    <img src='<%=context %>/common/images/Question.png' height="20px" width="20px" ><span style="margin-left: 10px; margin-right: 60px">회원가입/탈퇴</span><strong>회원가입에 연령 제한이 있나요?</strong>
      </button>
    </h2>
 ...
 <img src='<%=context %>/common/images/Question.png' height="20px" width="20px" ><span style="margin-left: 10px; margin-right: 60px">회원가입/탈퇴</span><strong>탈퇴는 어디에서 할 수 있나요?</strong>
      </button>
    </h2>
 ...
 <img src='<%=context %>/common/images/Question.png' height="20px" width="20px" ><span style="margin-left: 10px; margin-right: 60px">회원가입/탈퇴</span><strong>탈퇴를 하게된다면 기존에 작성했던 게시물도 삭제되나요?</strong>
      </button>
    </h2>
