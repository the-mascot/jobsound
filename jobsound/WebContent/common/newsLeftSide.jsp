				...
				<div class="card">
					...
					<div class="card-img-overlay mt-3">
						<p class="card-title text-center"
							style="font-family: 'jalnan'; font-size: 30px; color: white;">취업기사</p>	 <!-- el 표기로 parameter 받아서 표시해야함 -->
					</div>
				</div>
				<ul class="list-unstyled mx-auto">
					<!-- href 설정 -->
					<c:choose>
						<c:when test="${sessionScope.page==3 }">
							<li class="nav-item py-1"><a
								class="side_nav nav-link border-bottom border-2" href="../gm/newsindex.do" style="color: red">가장 많이 본 뉴스</a></li>
							<li class="nav-item py-1"><a
								class="side_nav nav-link border-bottom border-2" href="../gm/boardlist.do">JOB 뉴스</a></li>
						</c:when>
						<c:when test="${sessionScope.page==4 }">
							<li class="nav-item py-1"><a
								class="side_nav nav-link border-bottom border-2" id="nav1" href="../gm/newsindex.do">가장 많이 본 뉴스</a></li>
							<li class="nav-item py-1"><a
								class="side_nav nav-link border-bottom border-2" id="nav2" href="../gm/boardlist.do" style="color: red">JOB 뉴스</a></li>
						</c:when>
					</c:choose>
				</ul>
			</div>
